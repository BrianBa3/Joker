...
<div class="card">
  <div class="card-header" data-background-color="blue">
      <h4 class="title"><i class='fa fa-flask'></i> Módulos</h4>
  </div>
  <div class="card-content table-responsive">
	<a href="index.php?view=newproject" class="btn btn-default"><i class='fa fa-flask'></i> Nuevo Módulo</a>
		<?php
		...
		if(count($users)>0){
			...
			echo "<p class='alert alert-danger'>No hay Módulos</p>";
		}
